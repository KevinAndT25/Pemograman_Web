    ...
    <!-- Back to study -->
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-4 d-flex">
          <div class="container">
            <a href="blog-pweb/pertemuan-6.php" class="text-decoration-none text-dark w-100">
        ...
        <div class="col-md-6 mb-4 d-flex">
          <div class="container">
            <a href="blog-pweb/pertemuan-7.php" class="text-decoration-none text-dark w-100">
              <div class="card-materi h-100">
                  <div class="card-title">Laporan Praktikum - Pertemuan 7</div>
                  <div class="card-subtitle">Instalasi dan Konfigurasi Aplikasi Laravel</div>
                  <img src="picture/p7/laravel_home.png" alt="Pertemuan 7">
              </div>
            </a>
          </div>
        </div>
        ...
        <div class="col-md-6 mb-4 d-flex">
          <div class="container">
            <a href="blog-pweb/pertemuan-8.php" class="text-decoration-none text-dark w-100">
              <div class="card-materi h-100">
                  <div class="card-title">Laporan Praktikum - Pertemuan 8</div>
                  <div class="card-subtitle">LARAVEL AUTH, CRUD Multi Level User</div>
                  <img src="picture/p8/17login.png" alt="Pertemuan 8">
              </div>
            </a>
          </div>
        </div>
        ...
        <div class="col-md-6 mb-4 d-flex">
          <div class="container">
            <a href="blog-pweb/pertemuan-10.php" class="text-decoration-none text-dark w-100">
              <div class="card-materi h-100">
                  <div class="card-title">Laporan Praktikum - Pertemuan 10</div>
                  <div class="card-subtitle">Laravel Relationship Student, Major, dan Subject</div>
                  <img src="picture/p10/33result.png" alt="Pertemuan 10">
              </div>
            </a>
          </div>
        </div>
        ...
        <div class="col-md-6 mb-4 d-flex">
          <div class="container">
            <a href="blog-pweb/pertemuan-15.php" class="text-decoration-none text-dark w-100">
              <div class="card-materi h-100">
                  <div class="card-title">Tugas Perkuliahan - Pertemuan 15</div>
                  <div class="card-subtitle">API dan RESTful API</div>
                  <img src="picture/p15/23post.png" alt="Pertemuan 15">
              </div>
            </a>
          </div>
        </div>
