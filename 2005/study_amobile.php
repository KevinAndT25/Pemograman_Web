...
<body>
  ...
  <main class="container-fluid px-4 py-5">
    ...
    <!-- Back to study -->
      <a href="study.php" class="back-btn"><i class="fas fa-arrow-left"></i> Aplikasi Mobile</a>
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-4 d-flex">
          <div class="container">
            <a href="blog-amobile/pertemuan-1.php" class="text-decoration-none text-dark w-100">
              <div class="card-materi h-100">
                  <div class="card-title">Laporan Praktikum - Pertemuan 1</div>
        ...
        <div class="col-md-6 mb-4 d-flex">
          <div class="container">
            <a href="blog-amobile/pertemuan-2.php" class="text-decoration-none text-dark w-100">
              <div class="card-materi h-100">
